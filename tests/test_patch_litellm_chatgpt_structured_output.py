...
SCRIPT_PATH = (
    ...
    / "scripts"
    / "patch_litellm_chatgpt_structured_output.py"
)


class PatchLiteLLMChatGPTStructuredOutputTests(unittest.TestCase):
    def _load_patch_module(self):
        spec = importlib.util.spec_from_file_location(
            "patch_litellm_chatgpt_structured_output",
            SCRIPT_PATH,
        )
    ...
    def test_preserves_text_format_without_unsupported_output_limit(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertNotIn('"max_output_tokens",', patched)
